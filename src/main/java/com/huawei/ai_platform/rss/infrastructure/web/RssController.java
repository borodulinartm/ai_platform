...
public class RssController {
    ...
    public ResponseEntity<?> uploadReportToServer(
            ...
            @RequestBody List<RssNewsReportDto> body
    ) {
        Map<Integer, RssCategoryEntity> categoryEntityList = rssConfigService.listCategories()
                .stream().collect(Collectors.toMap(RssCategoryEntity::getId, Function.identity(), (a, b) -> a));
        List<RssNewsSummary> newsSummaries = rssNewsAssembler.toAggregate(body, categoryEntityList);
